...
import { RandomMessaje, AccessToken, ResAccesToken } from 'src/app/models/interfaces';
...
export class AutoClaimService {
  ...
  async startClaimSlp(ronin: string, privateKey: string): Promise<string>{
